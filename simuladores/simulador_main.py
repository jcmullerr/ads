...
for qt in range(qt_testes):
    ...
    print(f"\nHISTOGRAMA: \n {filaUnica[2]}")
    plt.bar(filaUnica[2].keys(),filaUnica[2].values())  
    plt.savefig("./fig/filaUnica[" +str(qt)+"].jpg")
    ...
    print(f"\nHISTOGRAMA: \n {doisWorkersFilas[2]}")
    plt.bar(doisWorkersFilas[2].keys(),doisWorkersFilas[2].values()) 
    plt.savefig("./fig/doisWorkersFilas[" +str(qt)+"].jpg")
    ...
    print(f"\nHISTOGRAMA: \n {multiplosWorkers[2]}")
    plt.bar(multiplosWorkers[2].keys(),multiplosWorkers[2].values())  
    plt.savefig("./fig/multiplosWorkers[" +str(qt)+"].jpg")
